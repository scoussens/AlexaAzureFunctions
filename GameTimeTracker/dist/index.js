...
const handlersState_1 = require("./handlersState");
...
exports.index = (context, req) => {
    ...
    alexa.appId = APP_ID;
    alexa.registerHandlers(handlersNewSession_1.NewSessionHandlers, handlersState_1.StartStateHandlers, handlersState_1.HelpStateHandlers);
    alexa.execute();
};
